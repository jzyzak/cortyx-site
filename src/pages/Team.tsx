    ...
    <main className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-8 md:px-20 py-24 text-white text-center">
      ...
      >
        ...
        <p className="text-gray-300 max-w-2xl mx-auto">
          I'm currently the sole developer/founder of Cortyx. I'm going to cut straight to it: traditional education is straight boring.
          ...
          feel free to reach out at <a href="mailto:jzyzak@college.harvard.edu" className="text-primary underline">jzyzak@college.harvard.edu</a>
        </p>
      </motion.div>
    </main>
  );
